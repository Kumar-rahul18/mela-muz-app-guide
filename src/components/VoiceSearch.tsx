...
const VoiceSearch: React.FC<VoiceSearchProps> = ({ onFacilityFound }) => {
  ...
  const facilityKeywords = {
    ...
    'toilet': ['toilet', 'टॉयलेट', 'washroom', 'बाथरूम', 'शौचालय','संडास','प्रसाधन','लेट्रिन','पखाना','पैखाना', 'हगने' , 'मूत्र', 'पेशाब' ],
    'bathroom': ['bathroom', 'बाथरूम', 'नहाने', 'bath', 'shower','नहाने की जगह', 'स्नानघर'],
    ...
    'parking': ['parking', 'पार्किंग', 'गाड़ी', 'car', 'vehicle', 'वाहन', 'vehicle', 'bolero', 'scorpio', 'bus','मोटरसाइकिल', 'बाइक', ' टेंपो', 'ऑटो' , 'ट्रैक्टर '],
