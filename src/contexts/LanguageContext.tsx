...
const translations: Translations = {
  ...
  en: {
    ...
    location_denied_error:
      'Location access denied. Please check app permissions in device settings.',
    ...
    litchi_gardens_desc:
      'Muzaffarpur is famously known as the "Litchi Kingdom." Vast orchards—especially in Mushahari, Jhapaha, and Bochaha—produce over 300,000 tonnes of litchi annually. Visiting in May–June during harvest season is a feast for the senses.',
    garibnath_temple: 'Baba Garibnath Temple (Garib Sthan)',
    garibnath_temple_desc:
      'Garibnath Temple is known as the "Deoghar of Bihar" due to its deep spiritual significance and divine Shiva lingam. Thousands of devotees visit during Shravan and Mahashivratri to offer holy water and seek blessings from Lord Shiva.',
    jubba_sahni_park: 'Jubba Sahni Park',
    jubba_sahni_park_desc:
      'This tranquil public park, named after a freedom fighter, offers shaded walkways and open spaces for families and leisurely evenings. Perfect for spending good time with friends',
    ramchandra_museum: 'Ramchandra Shahi Museum',
    ramchandra_museum_desc:
      'Located near the park, this museum features regional artifacts: sculptures (like Ashtadik Pal, Manasa Nag), coins, manuscripts, utensils—giving a glimpse into local history.',
    khudiram_memorial: 'Khudiram Bose Memorial',
    khudiram_memorial_desc:
      'A tribute to the 18-year-old Bengali revolutionary executed in 1908; the memorial stands near the site of his trial and death, significant to India\'s freedom struggle.',
    motijheel: 'Motijheel',
    motijheel_desc:
      'From getting its name from the local netizens to becoming a perfect cinematic location, the surrounding towers make it look stunning at dusk.',
    feedback: 'Feedback',
  },
  ...
  hi: {
    ...
    location_denied_error:
      'लोकेशन एक्सेस से इनकार किया गया। कृपया डिवाइस सेटिंग्स में ऐप अनुमतियां जांचें।',
    ...
    litchi_gardens_desc:
      'मुजफ्फरपुर को "लीची राज्य" के नाम से जाना जाता है। विशाल बगान—विशेष रूप से मुशहरी, झपाहा और बोचाहा में—सालाना 300,000 टन से अधिक लीची का उत्पादन करते हैं। मई‑जून में फसल के मौसम में जाना इंद्रियों के लिए एक दावत है।',
    garibnath_temple: 'बाबा गरीबनाथ मंदिर (गरीब स्थान)',
    garibnath_temple_desc:
      'शहर के केंद्र में एक पवित्र भगवान शिव मंदिर, जिसे बिहार के "देवघर" के रूप में भी जाना जाता है। एक खून बहने वाले पीपल के पेड़ में खोजे गए शिवलिंग के चारों ओर बना, यह श्रावण (जुलाई‑अगस्त) के दौरान विशेष रूप से जीवंत रहता है।',
    jubba_sahni_park: 'जुब्बा साहनी पार्क',
    jubba_sahni_park_desc:
      'एक स्वतंत्रता सेनानी के नाम पर रखा गया यह शांत सार्वजनिक पार्क, छायादार पैदल रास्ते और खुले स्थान प्रदान करता है—परिवारों और आरामदायक शामों के लिए बिल्कुल सही।',
    ramchandra_museum: 'रामचंद्र शाही संग्रहालय',
    ramchandra_museum_desc:
      'पार्क के पास स्थित, इस संग्रहालय में क्षेत्रीय कलाकृतियां हैं: मूर्तियां (जैसे अष्टदिक पाल, मनसा नाग), सिक्के, पांडुलिपियां, बर्तन—स्थानीय इतिहास की एक झलक देते हुए।',
    khudiram_memorial: 'खुदीराम बोस मेमोरियल',
    khudiram_memorial_desc:
      '1908 में फांसी दिए गए 18 वर्षीय बंगाली क्रांतिकारी को श्रद्धांजलि; स्मारक उनके मुकदमे और मृत्यु के स्थान के पास खड़ा है, जो भारत के स्वतंत्रता संग्राम के लिए महत्वपूर्ण है।',
    motijheel: 'मोतीझील',
    motijheel_desc:
      'स्थानीय लोगों से अपना नाम पाने से लेकर एक परफेक्ट सिनेमैटिक स्थान बनने तक, और चारों ओर फैले टावर इसे संध्या समय में एकदम सुंदर बना देते हैं।',
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  /* Show selector only the first time */
  ...
  return (
    <LanguageContext.Provider
      value={{ language, setLanguage, t, showLanguageSelector, setShowLanguageSelector }}
    >
      {children}
    </LanguageContext.Provider>
  );
