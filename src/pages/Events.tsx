...
const Events = () => {
  ...
  const events = [
      ...
      description: 'लाइव दर्शन में जाकर आरती देखें',
      type: 'आरती'
    },
         {
      date: 'प्रतिदिन',
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full ${
                    event.type === 'धार्मिक' ? 'bg-orange-100 text-orange-700' :
                    event.type === 'सांस्कृतिक' ? 'bg-blue-100 text-blue-700' :
                    event.type === 'आरती' ? 'bg-green-100 text-green-800' :
