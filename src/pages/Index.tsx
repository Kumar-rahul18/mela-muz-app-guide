  ...
  return (
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <div className="fixed inset-0 w-full h-full z-0">
        ...
        >
          <source src="/WhatsApp Video 2025-07-02 at 01.03.21.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10">
        ...
        {showContacts ? (
          ...
          <div className="px-4 py-6 space-y-6">
            ...
            <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 rounded-2xl p-6 text-white shadow-lg animate-fade-in backdrop-blur-sm bg-opacity-90">
            ...
            <div className="animate-fade-in">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg backdrop-blur-sm bg-white/10">
              ...
              <div className="grid grid-cols-2 gap-3">
                {quickAccessItems.map((item, index) => (
                  <div 
                    key={index}
                    onClick={item.action}
                    className="bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-sm border border-gray-100 cursor-pointer transform transition-all duration-200 hover:scale-105 active:scale-95"
                  >
                    {item.component ? (
                      item.component
                    ) : (
